...
class HalModuleDebugSinkTest(unittest.TestCase):
    ...
    def testHalModuleBufferViewTraceCallbackWithoutCircularReferenceDoesNotLeak(self):
        """Check that if we do not hold reference to the HAL module or VM context the
        callback object does not leak.
        """
    ...
    def testHalModuleBufferViewTraceCallbackCircularReferenceDoesNotLeak(self):

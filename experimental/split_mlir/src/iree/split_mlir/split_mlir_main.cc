...
// This is mostly copied from the source code of the iree-opt executable.
// Here is added registration of the relevant passes for splitting MLIR.
...
int main(int argc, char **argv) {
  ...
  mlir::iree::split_mlir::registerPasses();

...
manylinux_docker_image="${manylinux_docker_image:-gcr.io/iree-oss/manylinux2014_x86_64-release@sha256:cb77ecaedee1987bc38dc5393f6570566c4c4c89697255158ebce3b073e11ca0}"

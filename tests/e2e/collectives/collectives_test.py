...
class FourRanks(unittest.TestCase):
    ...
    def test_unrolled_mesh_all_reduce_and_matmul_on_2d_mesh_along_axis_0(self):
        """
        Test on a 2x2 device mesh multiple consecutive reductions and matmuls
        in a loop along mesh dimension 0.
        Mesh devices:
        axis 1
        ------>
        0 1
        ...
        run_test(
            ...
            inputs=inputs,
            expected_outputs=expected_outputs,
            name="FourRanks.test_unrolled_mesh_all_reduce_and_matmul_on_2d_mesh_along_axis_0"
        )
